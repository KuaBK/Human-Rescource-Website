package CNPM.G14.ems.exception;
...
public enum ErrorCode {
    ...
    DURATION_CALCULATION_ERROR(2005, "Unable to calculate duration; check-out time is missing.", HttpStatus.BAD_REQUEST),
    ...
    ATTENDANCE_NOT_FOUND(2006, "Manager not found", HttpStatus.NOT_FOUND),
    NOT_FOUND(2007, "Entity not found", HttpStatus.NOT_FOUND),
    ;

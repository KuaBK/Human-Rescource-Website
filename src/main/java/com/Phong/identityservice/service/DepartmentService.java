...
public class DepartmentService {
    ...
    public Department saveDepartment(Department department) {
        if (department.getManager() != null) {
            Manager manager = managerRepository.findById(department.getManager().getPersonelCode())
        ...
        try {
            ...
            throw new AppException(ErrorCode.DEPARTMENT_NAME_ALREADY_EXISTS); // Custom error code for duplicate department name
        } catch (Exception e) {
